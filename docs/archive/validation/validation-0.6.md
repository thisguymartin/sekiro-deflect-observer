...
interpretation rules and limits are in [cue scope](../../gameplay/legacy-timing.md),
[model coverage](../../research/data/enemy-coverage.json) and
[response evidence](../../research/data/response-coverage.json).
