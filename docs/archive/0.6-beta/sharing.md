...
0.12.4 me3 preview, use the [installation guide](../../users/install.md) and
[practice controls](../../gameplay/practice.md). Do not label the older ZIP as a
...
The [build guide](../../development/build.md) covers the current me3 installation and
...
Use the text in [the listing draft](nexus-listing-draft.md), add accurate versioned
