...
For the native Rust observer included in this repository, use
[the current installation instructions](../../users/install.md). It does not
depend on the original prototype. This document covers the separate, older
Cheat Engine research path.
...
2. Save the clips and fill in the report before starting combat. Investigate contradictions using [the effect analysis procedure](../../research/reverse-engineering.md).
